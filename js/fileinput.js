...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderBrowse: function () {
            ...
            return '<div class="btn-xs ' + css + '"' + status + '> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
        renderRemove: function () {
            ...
            return '<button type="button" class="btn-xs ' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
        renderUpload: function () {
            ...
            if (isEmpty(self.uploadUrl)) {
                content = '<button type="submit" class="btn-xs ' + self.uploadClass + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            }
            else {
                content = '<a href="' + self.uploadUrl + '" class="btn-xs ' + self.uploadClass + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</a>';
            }
            return content;
        }
    }
